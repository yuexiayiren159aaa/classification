...
class Classification(object):
    _defaults = {
        ...
        # "model_path"    : 'logs_1231/ep053-loss0.004-val_loss0.116.pth',
        # "model_path"    : 'logs_mask_close/ep036-loss0.004-val_loss0.142.pth',
        # "model_path"    : 'logs/ep051-loss0.001-val_loss0.328.pth',
        "model_path"    : 'logs_newnet/ep096-loss0.019-val_loss0.091.pth',
    ...
    def detect_image(self, image):
        ...
        test = str(class_name) + "_" + str(probability)
        print(test)

        cv2.putText(np.array(image), test, (10, 20),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255),2)
        cv2.imwrite("img_save/{}.png".format(test),np.array(image))
