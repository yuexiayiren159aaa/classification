...
class Mb_Tiny_RFB(nn.Module):
    ...
    def __init__(self, num_classes=2):
        ...
        self.model = nn.Sequential(
            ...
            conv_dw(self.base_channel * 8, self.base_channel * 8, 1),
            #增加一个RFB
            # BasicRFB(self.base_channel * 8, self.base_channel * 4, stride=1, scale=1.0),
...
def rfb(num_classes=9):
    model = Mb_Tiny_RFB(num_classes=num_classes)
...
if __name__ == '__main__':
    net = Mb_Tiny_RFB()
    summary(net, (3, 600, 600), batch_size=1, device="cpu")